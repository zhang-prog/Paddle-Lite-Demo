...
2. 填写 [问卷](https://paddle.wjx.cn/vm/rWPncBm.aspx#) 下载压缩包，将压缩包放到指定解压目录，切换到指定解压目录后执行解压命令。

    ```shell
    # 1. 切换到指定解压目录
    cd PaddleX-Lite-Deploy/image_classification/android/shell/cxx/image_classification
